...
var style_IndicedeVegetacion_2 = function(feature, resolution){
    ...
    if (value >= 0.183857 && value <= 0.309052) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.309052 && value <= 0.434247) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.434247 && value <= 0.559443) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.559443 && value <= 0.684638) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.684638 && value <= 0.809833) {
            style = [ new ol.style.Style({
